...
<div class="container-fluid jumbotron py-4">
  ...
  <img src="Images/x.png" width="200" height="80" alt="">
  </div>
  <div class="row " style="padding-top: 100px;">
    
    <div class="col-md-4" style="padding-top: 40px;">
      <div class="lead text-center">
      <img src="Images/food.png" width="250" height="150">
      </div>
    </div>
    <div class="col" style="padding-top: 40px;">
      
      <h3><b>Food deliver </b></h3>
      <p>Food deliver mobile software detecting and searching items available in the stock.This software is build with <b>Xamarin and C#,SQL,ASP.NET</b>. A role base on stocking system
        was implemented to create permission base on role.The role of Admin.Project Manager restrict what the user
         can see and do.<br>
        The system was build with <b>Xamarin and C#,SQL,ASP.NET</b> and hosted on Azure Cloud.
      </p>
